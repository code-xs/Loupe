...
# 1. 项目级 Skill（当前工程 .cursor/skills/）
create_symlink "${PROJECT_ROOT}/.cursor/skills"

# 2. 个人级 Skill（~/.cursor/skills/，跨项目可用）
create_symlink "${HOME}/.cursor/skills"

echo ""
echo "Done. 请在 Cursor 中开启新对话以激活 Skill。"
